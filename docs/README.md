...
- [ ] [MapAnything]. Check where autocast is required.
- [ ] [MapAnything]. Check output format.
- [ ] [MapAnything]. Check if inference postprocessing function is required within forward function for my goals.