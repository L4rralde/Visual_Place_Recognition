...
def compare_pipelines(
    ...
    for i in range(num_seeds):
        ...
        acc_diff = 0.0
        for i, (ref_pred, pred) in enumerate(zip(baseline_preds, with_salad_preds)):
...
def main() -> None:
    ...
    mapanything = load_pretrained_mapanything().to(device)
    ...
    compare_pipelines(mapanything, with_salad, dataset, device, num_seeds=args.num_seeds)
